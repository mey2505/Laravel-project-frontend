        ...
        <div class="flex flex-col">
          ...
          <div class="mt-7 flex items-center gap-3">
            ...
            <button
              ...
              @click="addToCart"
              :disabled="adding"
              class="flex-1 bg-amber-400 hover:bg-amber-300 text-zinc-950 font-semibold py-2.5 px-6 rounded-md transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
